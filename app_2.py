...
def main():
   ...
   # st.title("Scene Text Detection And Recognition Using EAST And Tesseract")
    ...
    st.markdown("""
    	### Description
    	+ we are using any natural image or scene (not particularly documents, licence, or vehicle number) and for a given image/scene we want to localize char/word/sentence in the image by bounding box. After that, we want to recognize the localized texts.
